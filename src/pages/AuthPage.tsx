          ...
          <div className="bg-card-gradient border border-border rounded-xl p-8 shadow-dramatic">
            <div className="text-center mb-8">
              ...
              <p className="text-sm text-muted-foreground mt-2">
                {isLogin ? "Sign in to your archive" : "Join the Universal History Archive"}
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full flex items-center justify-center gap-2 rounded-lg bg-primary text-primary-foreground py-3 font-medium text-sm hover:opacity-90 transition-opacity disabled:opacity-50"
              >
